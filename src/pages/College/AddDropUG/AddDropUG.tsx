        ...
        <div className="flex  justify-between mb-4">
          ...
          <div className="flex items-center">
            <div className="mb-3 ml-3">
              ...
              <button
                className="text-white bg-main-blue p-2 rounded ml-2"
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-4 rounded-lg w-full max-w-xl">
              ...
              <div className="flex mt-2">
                ...
                <div className="w-1/4 flex flex-col">
                  <div className="flex flex-row justify-between ">
                    ...
                    <p className="text-sm mr-2 text-main-red font-bold">
                      BSCS 4-1
                    </p>
                  </div>
                  <div className="flex flex-row justify-between">
                ...
                <div className="w-3/4 ml-2">
                  <div className="flex flex-row justify-between">
                    <label
                      htmlFor="employeeNumber"
                      className="text-sm font-medium mr-2 text-main-red"
                    >
                      Class Code - Section
                    </label>
                  ...
                  <tbody className="text-center border">
                    <tr className="border">
                      ...
                      <td className="px-4 py-2">
                        ...
                        >
                          <option>
                            CSC 0411 - 2, 3 Units, T 7:00a-8:30a LEc GCA 306, F
                            7:00a-8:30a LecSyncOnline FIELD
                          </option>
                        </select>
                      </td>
                      <td className="px-4 py-2">
              ...
              <div className="flex justify-start mt-4">
                <button className="text-white bg-main-red p-2 rounded">
                  Add Class
                </button>
              </div>
            </div>
        ...
        {AddDropModalOpen && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-4 rounded-lg w-full max-w-xl">
              ...
              {/* Class Code */}
              <p className="text-gray mt-10 text-sm">
                Note: To cancel subject click the Trash Icon
              </p>
              <div className="overflow-x-auto mt-2">
                <table className="min-w-full table-auto  bg-white shadow-md rounded-lg">
                  <thead>
              ...
              <div className="flex justify-between mt-4">
                <div>
                  ...
                  <p className=" text-[10px]">
                    Search a Class to Pick a Schedule
                  </p>
                </div>

                <button className="text-white bg-main-red p-1 rounded">
                  Add Class
                </button>
              </div>
