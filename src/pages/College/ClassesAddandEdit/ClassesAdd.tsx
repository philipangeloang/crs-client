...
const ClassesAdd = () => {
  ...
  const renderStep = () => {
    switch (currentStep) {
      case 1:
        return (
          <div className="flex ">
            <h1 className="text-2xl text-red-600 mr-2 font-bold">Step 1:</h1>
            <span className="text-2xl text-red-600 mr-2 font-light">
              Class Information
            </span>
          </div>
        );
      case 2:
        return (
          <div className="flex ">
            <h1 className="text-2xl text-red-600 mr-2 font-bold">Step 2:</h1>
            <span className="text-2xl text-red-600 mr-2 font-light">
              Class Hours
            </span>
          </div>
      ...
      case 3:
        return (
          <div className="flex ">
            <h1 className="text-2xl text-red-600 mr-2 font-bold">Step 3:</h1>
            <span className="text-2xl text-red-600 mr-2 font-light">
              Class Restriction
            </span>
          </div>
      ...
      case 4:
        return (
          <div className="flex ">
            <h1 className="text-2xl text-red-600 mr-2 font-bold">FINISH:</h1>
            <span className="text-2xl text-red-600 mr-2 font-light">
              Class Added
            </span>
          </div>
  ...
  const divs = [
    ...
    <div className="w-full mt-10 p-5 border shadow rounded" key={1}>
      ...
      <div className="mb-3">
        <label htmlFor="NSTP" className="form-label">
          NSTP Activity:{" "}
        </label>
        <input
          type="text"
          className="form-control border ml-8 w-1/4 rounded p-1"
        />
        <span className="text-sm text-main-red ml-3">
          (to be filled only if class to be added is an NSTP subject){" "}
        </span>
      </div>
      <div className="mb-3">
      ...
      <div className="mb-3 flex flex-row items-center justify-start">
        ...
        <input
          type="text"
          className="form-control border m-3 w-1/4 rounded p-1"
        />
        <span className="text-sm text-main-red ml-3">
          (fill-up if displayed Credits is not the actual class credit)
        </span>
      </div>
      <div className="mb-3">
        <div className="flex flex-row">
          <label className="form-label">
            Faculty:
            <br />
            <span className="text-sm text-main-red">
              Leave it blank if TBA
            </span>{" "}
          </label>
        ...
        <div className="mb-3 flex flex-row items-center justify-start mt-5">
          ...
          <input
            type="text"
            className="form-control border w-1/4 rounded p-1 ml-2"
          />
          ...
          <a href="" className="text-sm text-main-blue ml-3">
            Click here for help on how to use this
          </a>
        </div>
        <div className="mb-2">
          <span className="text-sm text-main-red">
            NOTE: If course is dependent on another course, write the class code
            of the parent course. Lab and discussion classes usually have
            lecture components, therefore, field must be filled-up.
          </span>
        </div>
      ...
      <div className="border mt-5">
        <div className="overflow-x-auto">
              ...
              {Array.from({ length: 7 }, (_, index) => (
                <tr className="border" key={index}>
                  ...
                  <td className="px-4 py-2">
                    <input
                      type="text"
                      className="form-control border w-3/4 rounded p-1 ml-2"
                    />
                  </td>
                  <td className="px-4 py-2">
          ...
          <div className="w-full flex flex-row justify-center items-center">
            <button className=" w-[5rem] bg-main-red text-white p-2 mt-2 m-2 rounded">
              Save
            </button>
          </div>
        </div>
    ...
    <div className="w-full mt-20 mb-20" key={4}>
      ...
      <h1 className="text-5xl text-center mt-10 text-main-red">
        Class record saved! Redirecting to the list of Classes
      </h1>
    </div>,
  ];
  ...
  return (
    ...
    <div className="p-10 px-16 grid grid-cols-12 font-montserrat relative">
      ...
      <div className="col-span-12 mt-4">
        <div className="relative pt-4">
          <div className="flex relative shadow">
            <div
              className={` bg-main-red rounded-full h-2 ${getProgressWidth()}`}
            >
              ...
              <div className="absolute top-0 left-2/4 transform -translate-x-20 -translate-y-4">
                <div
                  className={`w-10 h-10 shadow border border-red-200  text-main-red rounded-full flex items-center justify-center ${getProgressWidth2()} `}
                >
                  2
                </div>
              </div>
              <div className="absolute top-0 left-3/4 transform -translate-x-20 -translate-y-4">
                <div
                  className={`w-10 h-10 border border-red-200 text-main-red rounded-full flex items-center justify-center ${getProgressWidth3()}`}
                >
                  3
                </div>
              </div>
              <div className="absolute top-0 right-0 transform -translate-x-20 -translate-y-4">
                <div
                  className={`w-10 h-10 border border-red-200 text-main-red rounded-full flex items-center justify-center ${getProgressWidth4()}`}
                >
                  <MdCheck />
                </div>
              </div>
      ...
      <div className="col-span-12 mt-4">
        <div className="relative pt-4">
          <div className="flex relative">{divs[currentStep - 1]}</div>
        </div>
      </div>
