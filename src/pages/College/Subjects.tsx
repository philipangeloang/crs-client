        ...
        <div className="p-10 px-16 grid grid-cols-12 font-montserrat" >
            ...
            <div className="col-span-12 mt-20">
                <div className="flex justify-between mb-4">
                    ...
                    <div className="flex items-center">
                        <button className=" bg-main-red text-white rounded-lg p-2 ml-3" onClick={openSubjectModal}>
                            Add Subject
                        </button>
                        <button >
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white p-4 rounded-lg w-full max-w-lg">
                        <div className="flex justify-between">
                            <h2 className="text-xl text-main-red mb-4">Subject Information
                            </h2>
                        ...
                        <div className="mt-5">
                            <div className="flex flex-row">
                                <div className="flex flex-col">
                                    ...
                                    <input className="border p-1 rounded" type="text" placeholder='ex. CSC 0413' />
                                </div>
                                ...
                                <div className="flex flex-col ml-3">
                                    ...
                                    <input className="border p-1 rounded" type="text" placeholder='ex. 3' />
                                </div>
                                <br />
                            </div>
                            ...
                            <div>
                                <div className="w-full flex flex-col mt-2 mb-2">
                                    <label className="mt-1 mb-2" htmlFor="">Subject Name</label>
                                    <input className="border p-2 rounded" type="text" placeholder='ex. CS ELECTIVE 2' />
                                </div>
                            </div>
