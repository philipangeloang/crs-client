...
const Curriculum = () => {
  ...
  const [selectedEditItem, setSelectedEditItem] = useState<{ program: string; programName: string; curriculum: string } | null>(null);
  ...
  // Dummy data 
  const tableData = [
    { courseCode: 'GEIT 822', couseTitle: 'ADVANCED DATABASE SYSTEMS', preresequite: '---' },
    { courseCode: 'GEIT 822', couseTitle: 'ADVANCED DATABASE SYSTEMS', preresequite: '---' },
    { courseCode: 'GEIT 822', couseTitle: 'ADVANCED DATABASE SYSTEMS', preresequite: '---' },
    { courseCode: 'GEIT 822', couseTitle: 'ADVANCED DATABASE SYSTEMS', preresequite: '---' },
    { courseCode: 'GEIT 822', couseTitle: 'ADVANCED DATABASE SYSTEMS', preresequite: '---' },
  ...
  const tableCurriculum = [
    { program: 'ME-CE', programName: 'Master of Engineering with Specialization in Computer Engineering', curriculum: 'ME-CE2016' },
    { program: 'ME-CE', programName: 'Master of Engineering with Specialization in Computer Engineering', curriculum: 'ME-CE2016' },
    { program: 'ME-CE', programName: 'Master of Engineering with Specialization in Computer Engineering', curriculum: 'ME-CE2016' },
    { program: 'ME-CE', programName: 'Master of Engineering with Specialization in Computer Engineering', curriculum: 'ME-CE2016' },
  ...
  // Edit modal
  const openEditModal = (editItem: { program: string; programName: string; curriculum: string }) => {
        ...
        <div className="col-span-12 mt-20">
          ...
          <div className="flex flex-row mt-10 ">
            <ul className="border max-h-[300px] w-[200px] overflow-y-auto shadow p-2">
              <h2 className='bg-main-red text-white font-bold p-1'>Curriculums List</h2>
              ...
              {selectedCurriculum && (
                <div className=' border w-full'>
                  <div className="flex justify-between mt-1 p-2">
                    <div className="flex ">
                      <h2 className='text-main-red text-2xl font-bold'>{selectedCurriculum.name}</h2>
                    </div>

                    <div className="flex items-center ">
                      <button className=" bg-main-red text-white rounded-lg p-2 ml-3" onClick={openCurriculumModal}>
                        Add Subject
                      </button>
                    ...
                    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                      <div className="bg-white p-4 rounded-lg w-full max-w-lg">
                        <div className="flex justify-between">
                          <h2 className="text-xl text-main-red mb-4">{selectedCurriculum.name}
                          </h2>
                          <button className="flex bg-main-red items-center text-white p-2 rounded" onClick={closeCurriculumModal}>
                            X
                          </button>
                        </div>
                        <hr />
                          ...
                          <div className='w-full'>
                            {selectedOption && (
                              <div className='flex justify-between border p-2 mb-2'>
                                <p>{selectedOption}</p>
                                <button className='bg-main-red text-white p-1 rounded' onClick={handleRemoveOption}><FaMinusCircle /></button>
                              </div>
                            )}
            ...
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
              <div className="bg-white p-4 rounded-lg w-full max-w-lg">
                <div className="flex justify-between">
                  ...
                  <button className="flex bg-main-red items-center text-white p-2 rounded" onClick={closeEditModal}>
                    X
                  </button>
                </div>
                <hr />
