                        ...
                        <tbody className="text-center border">
                            {tableData.map((item) => (
                                <tr className="border" key={item.id}>
                                    <td className="text-center flex justify-center items-center m-auto" onClick={() => openModal(item)}>
                        ...
                        <div className="bg-white p-4 rounded-lg w-full max-w-2xl">
                            ...
                            <div>
                                ...
                                {selectedData && (
                                    <div className='flex justify-between  border p-1 shadow rounded'>
                                        ...
                                        <div className='flex flex-col'>
                                            ...
                                            <p>Total units after approved: {/* Add the appropriate data */}</p>
                                            <p>Reason: {/* Add the appropriate data */}</p>
                                            <p>Status: {selectedData.status}</p>
                                            <p>Approved by: ICTOCET</p>
                                            <p>Approved date: {/* Add the appropriate data (e.g., today's date) */}</p>
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="overflow-x-auto  mt-5 mb-2 h-[200px]">
                                    ...
                                    <h2 className='text-xl font-bold text-main-red mb-2 mt-5'>Dropped Classes</h2>
