...
const Faculty = () => {
  ...
  const [selectedFaculty, setSelectedFaculty] = useState<{ id: number; identity: string; name: string; designation: string; college: string; } | null>(null);
            ...
            <table className="min-w-full table-auto  bg-white shadow-md rounded-lg">
              ...
              <tbody>
                {faculty.map((facultyItem) => {
                  const matchingStaff = staff.find((staffItem) => staffItem.staff_id === facultyItem.staff_id);

                  if (matchingStaff) {
                    return (
                      <tr className="border" key={`${facultyItem.instructor_id}-${facultyItem.department_id}`}>
                        <td className="text-center">{facultyItem.instructor_id}</td>
                        <td className="text-center">{facultyItem.instructor_code}</td>
                        <td className="text-center">{matchingStaff.last_name}, {matchingStaff.first_name}, {matchingStaff.middle_name}</td>
                        <td className="text-center">{matchingStaff.designation}</td>

                        {facultyItem.departments && facultyItem.departments.length > 0 ? (
                          <td className="text-center">
                            {facultyItem.departments.map((department: { department_id: number, department_code: string, department_name: string }) => (
                              <div key={department.department_id}>
                                <span>{department.department_code} <br /> {department.department_name}</span><br />
                              </div>
                            ))}
                          </td>
                        ) : (
                        ...
                        <td className="text-center" style={{ color: facultyItem.employment_type === 'regular' ? 'green' : 'gray', fontWeight: 'bold' }}>
                          {facultyItem.employment_type === 'regular' ? 'Active' : 'None'}
                        </td>
                    ...
                    return (
                      <tr className="border" key={`${facultyItem.instructor_id}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <div className="mb-4">
                      ...
                      >
                        {staff.map((item) => (
                          <option key={item.staff_id} value={`${item.staff_id}-${item.employee_number}`}>
                    ...
                    <div className="mb-4">
                      ...
                      <input type="text" id="first_name" className="w-full border p-2 rounded" value={formData.first_name || ''} />
                    </div>
                    ...
                    <div className="mb-4">
                      ...
                      <input type="text" id="middle_name" className="w-full border p-2 rounded" value={formData.middle_name || ''} />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="mb-4">
                      ...
                      <input type="text" id="birthdate" className="w-full border p-2 rounded" value={formData.birth_date || ''} />
                    </div>
                  </div>
                </div>
                <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <div className="mb-4">
                      ...
                      <input type="text" id="firstName" className="w-full border p-2 rounded" />
                    </div>
                    <div className="mb-4">
                      <label htmlFor="middleName" className="text-sm font-medium">Middle Name</label>
                      <input type="text" id="middleName" className="w-full border p-2 rounded" />
                    </div>
                    <div className="mb-4">
                      <label htmlFor="middleInitial" className="text-sm font-medium">Middle Initial</label>
                      <input type="text" id="middleInitial" className="w-full border p-2 rounded" />
                    </div>
                    <div className="mb-4">
                      <label htmlFor="lastName" className="text-sm font-medium">Last Name</label>
                      <input type="text" id="lastName" className="w-full border p-2 rounded" />
                    </div>
                    <div className="mb-4">
                      <label htmlFor="suffix" className="text-sm font-medium">Suffix</label>
                      <input type="text" id="suffix" className="w-full border p-2 rounded" />
                    </div>
                    <div className="mb-4">
