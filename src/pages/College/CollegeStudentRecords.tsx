          ...
          <table className="min-w-full table-auto bg-white shadow-md rounded-lg border">
            ...
            <tbody>
              {students.map((studentItem) => {
                const matchingStudent = studentsTerms.find(
                  (studentTermItem) =>
                    studentTermItem.student_id === studentItem.student_id
                );

                if (matchingStudent) {
                  const matchingProgram = program.find(
                    (programItem) =>
                      programItem.program_id === matchingStudent.program_id
                  );

                  if (matchingProgram) {
                    const matchingCollege = colleges.find(
                      (collegeItem) =>
                        collegeItem.college_id === matchingStudent.college_id
                    );
                    ...
                    if (matchingCollege) {
                      return (
                        ...
                        >
                          <td className="text-center">
                            {studentItem.student_no}
                          </td>
                          <td className="text-center">
                            {studentItem.last_name}, {studentItem.first_name},{" "}
                            {studentItem.middle_name}
                          </td>
                          <td className="text-center">
                          ...
                          <td className="text-center">
                            {matchingStudent.registration_code}
                          </td>
                          <td className="text-center">
                            {matchingStudent.student_type}
                          </td>
                      ...
                      console.error(
                        `No matching college found for student ID ${matchingStudent.student_id}`
                      );
                    }
                  } else {
                    console.error(
                      `No matching program found for student ID ${matchingStudent.student_id}`
                    );
                  }
                } else {
                  console.error(
                    `No matching student term found for student ID ${studentItem.student_id}`
                  );
                }
          ...
          {studentModalOpen && (
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
              <div className="bg-white p-4 rounded-lg w-full max-w-lg">
                ...
                <h2 className="text-xl mb-4 text-main-red">
                  Student Terms Update
                </h2>
                ...
                <div className="flex flex-row mb-4">
                  <div className="flex-col mb-4 flex-grow">
                    ...
                    <h1 id="fullName" className="text-main-red font-bold">
                      SANTOS, MARIA CLARA REYES
                    </h1>
                  </div>
                  <div className="flex-col mb-4 flex-grow">
                    <label className="mb-1 text-sm" htmlFor="studentID">
                      Student ID
                    </label>
                    <h1 id="studentID" className="font-bold">
                      202012341
                    </h1>
                  </div>
                  <div className="flex-col mb-4 flex-grow">
                    <label className="mb-1 text-sm" htmlFor="enrolled">
                      Enrolled
                    </label>
                    <h1 id="enrolled" className="text-main-red">
                      No
                    </h1>
                  </div>
                </div>
                ...
                <div className="flex flex-row mb-4">
                  <div className="flex-col mb-4 w-1/2 mr-2">
                    ...
                    <div className="mb-2 mt-2">
                      <label className="mb-2 text-sm" htmlFor="middleName">
                        Middle Name
                      </label>
                      <br />
                      <input
                    ...
                    <div className="mb-2 mt-2">
                      <label className="mb-2 text-sm" htmlFor="middleInitial">
                        Middle Initial
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="mb-2 mt-2">
                      <label className="mb-2 text-sm" htmlFor="suffix">
                        Suffix
                      </label>{" "}
                      <br />
                      <input
                    ...
                    <div className="mb-2">
                      <label className="mb-2 text-sm" htmlFor="maiden">
                        Maiden
                      </label>{" "}
                      <br />
                      <input
                    ...
                    <div className="mb-2 flex">
                      ...
                      <div className="flex items-center ml-1 mb-2">
                        <input
                          type="checkbox"
                          id="graduatingStudentYes"
                          className="border rounded p-1"
                        />
                        <label htmlFor="graduatingStudentYes" className="ml-1">
                          Yes
                        </label>
                      </div>
                      <div className="flex items-center ml-2 mb-2">
                        <input
                          type="checkbox"
                          id="graduatingStudentNo"
                          className="border rounded p-1"
                        />
                        <label htmlFor="graduatingStudentNo" className="ml-1">
                          No
                        </label>
                      </div>
                    </div>
                  ...
                  <div className="flex-col mb-4 w-1/2">
                    <div className="mb-3">
                      <label className="mb-2 text-sm" htmlFor="studentType">
                        Student Type
                      </label>
                    ...
                    <div className="mb-3">
                      <label className="mb-2 text-sm" htmlFor="programCode">
                        Program Code
                      </label>
                      <select className="border p-1 rounded w-full">
                        <option>BSCS</option>
                    ...
                    <div className="mb-3">
                      <label className="mb-2 text-sm" htmlFor="collegeCode">
                        College Code
                      </label>
                      <select className="border p-1 rounded w-full">
                        <option>CET</option>
                    ...
                    <div className="mb-3">
                      <label className="mb-2 text-sm" htmlFor="block">
                        Block
                      </label>
                      <select className="border p-1 rounded w-full">
                    ...
                    <div className="mb-3">
                      <label className="mb-2 text-sm" htmlFor="yearLevel">
                        Year Level
                      </label>
                      <select className="border p-1 rounded w-full">
                        <option>4</option>
