      ...
      <div className="p-10 px-16 grid grid-cols-12 font-montserrat ">
        ...
        <div className="col-span-12 flex justify-between items-center">
          ...
          <div className="flex flex-col items-end">
            <h1 className="font-bold">{mockData.studentLastName}, {mockData.studentFirstName}</h1>
            <p className="text-xs">
              Graduate Student: <span className="text-main-red">{mockData.studentNumber}</span>
            </p>
          </div>
        </div>
        ...
        <div className="col-span-12 mt-12 flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-2/5 lg:w-2/5 ">
            ...
            <div className="p-3 mt-3 rounded-lg border border-black h-full flex flex-col justify-between">
              {/* Enrollment Status*/}
              <div>
                <span className="text-main-red font-bold">You are not yet Officially Enrolled for this term.</span>
              </div>
