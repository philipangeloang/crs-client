...
import { tableEmailBlast } from "./TestData";
import { Input } from "@/components/ui/input";

const AdminEmailBlast = () => {
  return (
    <>
      <div className="h-screen w-full p-10 px-16 flex flex-col justify-between font-montserrat overflow-x-hidden">
        ...
        <div className="mt-10 font-open-sans flex flex-col">
          ...
          <div className="grid grid-cols-12 mt-5 ">
            ...
            {/* Table Contents */}
            {tableEmailBlast.map((item) => (
              <>
                <div
                  className="col-span-2 px-2 py-3 border-l border-b border-main-gray flex flex-col justify-center text-center"
                  key={item.id}
                >
                  {item.studentNumber}
                </div>
