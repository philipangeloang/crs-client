...
import { tableCollegeModule } from "./TestData";
import { Input } from "@/components/ui/input";

const AdminCollegeModule = () => {
  return (
    <>
      <div className="h-screen w-full p-10 px-16 flex flex-col justify-between font-montserrat overflow-x-hidden">
        ...
        <div className="mt-10 font-open-sans flex flex-col">
          ...
          <div className="grid grid-cols-12 mt-5 ">
            {/* Table Header */}
            <div className="font-bold bg-main-red rounded-tl-lg text-white p-3 col-span-4 text-center ">
              College
            </div>
            ...
            {/* Table Contents */}
            {tableCollegeModule.map((item) => (
              <>
                <div
                  className="col-span-4 px-2 py-3 border-l border-b border-main-gray text-center flex flex-col justify-center"
                  key={item.id}
                >
                  {item.college}
                </div>
...
export default AdminCollegeModule;
